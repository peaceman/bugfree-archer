		...
		<ul class="media-list">
			...
			<li class="media">
				<a class="pull-left" href="{{{ route('shop-items.show', [$shopItem->activeRevision->slug]) }}}">
					<img class="media-object" src="{{{ $imageUrls->getUrlForFormat($shopItem->activeRevision->productRevision->getListingPictureFileAttribute(), 'product-listing') }}}" alt="" style="width: 130px;"/>
				</a>
